...
#targetText = "동해물과 백두산이 마르고 닳도록 하느님이 보우하사"
...
yestrday = dt.date(2023, 10, 31)
print(yestrday.weekday()) """
...
difday = dt.timedelta(haurs = 1000)
...
rs = statistics.median(data)

print("평균값 = ", res, "중간값 = ", rs) """
